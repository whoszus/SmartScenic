...
public class MScenicSpotinfo {
	private static final String warm1 = "空气质量令人满意,基本无空气污染 各类人群可正常活动。";
	private static final String warm2 = "空气质量可接受,但某些污染物可能对极少数异常敏感人群健康有较弱影响 极少数异常敏感人群应减少户外活动";
	private static final String warm3 = "易感人群症状有轻度加剧,健康人群出现刺激症状 儿童、老年人及心脏病、呼吸系统疾病患者应减少长时间、高强度的户外锻炼";
	private static final String warm4 = "进一步加剧易感人群症状,可能对健康人群心脏、呼吸系统有影响 儿童、老年人及心脏病、呼吸系统疾病患者避免长时间、高强度的户外锻炼,一般人群适量减少户外运动";
	private static final String warm5 = "心脏病和肺病患者症状显著加剧,运动耐受力降低,健康人群普遍出现症状 儿童、老人和心脏病、肺病患者应停留在室内,停止户外运动,一般人群减少户外运动";
	private static final String warm6 = "健康人运动耐受力降低,有明显强烈症状,提前出现某些疾病 儿童、老年人和病人应当留在室内,避免体力消耗,一般人群应避免户外活动";
	...
	public void setPollution(float Aqi) {
		if (Aqi > 300) {
			...
			this.warmReminder = MScenicSpotinfo.warm6;
		} else if (Aqi > 200) {
			this.ddAirPollutionIndex = "重度污染";
			this.warmReminder = MScenicSpotinfo.warm5;
		} else if (Aqi > 150) {
			this.ddAirPollutionIndex = "中度污染";
			this.warmReminder = MScenicSpotinfo.warm4;
		} else if (Aqi > 100) {
			this.ddAirPollutionIndex = "轻度污染";
			this.warmReminder = MScenicSpotinfo.warm3;
		} else if (Aqi > 50) {
			this.ddAirPollutionIndex = "良";
			this.warmReminder = MScenicSpotinfo.warm2;
		} else if (Aqi > 0) {
			this.ddAirPollutionIndex = "优";
			this.warmReminder = MScenicSpotinfo.warm1;
		} else {
